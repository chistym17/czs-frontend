      ...
      <div className='bg-white'>
        ...
        <section className='container mx-auto py-16 px-4 md:px-20'>
          <div className='grid md:grid-cols-2 gap-10 items-center'>
            ...
            <img
              src='/assets/photos/COVER2.png' // Replace with actual image
              alt='CZS Ground'
          ...
          <div className='grid md:grid-cols-2 gap-10 items-center mt-16'>
            <img
              src='/assets/photos/COVER3.png' // Replace with actual image
              alt='CZS Match'
              className='rounded-lg shadow-lg'
            />
            <div>
        ...
        <section className='bg-white py-16'>
          <div className='container mx-auto px-4'>
            ...
            <div className='grid md:grid-cols-3 gap-6'>
              {['COVER2.png', 'COVER3.png', 'COVER4.png'].map((img, idx) => (
                <img
                  key={idx}

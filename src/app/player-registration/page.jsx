...
export default function PlayerRegistration() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/player/register`, {
                method: 'POST',
                body: formData,
            });
                ...
                <div className="w-full max-w-xl">
                    ...
                    >
                        <div className="text-center">
                            <h2 className="text-2xl sm:text-3xl font-bold text-indigo-700 mb-2">Player Registration</h2>
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <label className="block text-md font-medium text-gray-700">Batch</label>
                                    <input
                                        type="text"
                                        name="batch"
                                        value={form.batch}
                                ...
                                <div className="space-y-2">
                                    <label className="block text-md font-medium text-gray-700">Position</label>
                                    <select
                                        name="position"
                                        value={form.position}
                                        onChange={handleChange}

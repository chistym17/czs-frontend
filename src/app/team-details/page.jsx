...
const TeamDetails = ({ params }) => {
  ...
  useEffect(() => {
    const fetchTeamData = async () => {
      try {
        const response = await fetch(`https://czs-backend.onrender.com/api/teams`);
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="flex gap-6">
                <div className="text-center">
                  ...
                  <p className="font-semibold text-blue-900">{team.captainName}</p>
                </div>
                <div className="text-center">
                  <p className="text-sm text-gray-500">Vice Captain</p>
                  <p className="font-semibold text-blue-900">{team.viceCaptainName}</p>
                </div>
              </div>
            </div>
          </div>

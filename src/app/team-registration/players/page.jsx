...
export default function PlayersRegistration() {
  ...
  useEffect(() => {
    ...
    const savedCurrentPlayer =
      parseInt(localStorage.getItem("currentPlayer")) || 1;
    const savedPlayersData = JSON.parse(
  ...
  const handleNextPlayer = async (playerData) => {
    ...
    if (currentStep.player === 18) {
      ...
      const completePlayers = playersData.map((player) => {
        const matchingImage = playersData.find(
          (p) => p.image?.playerID === player.image?.playerID
        );
        return {
          ...
          steps={[
            {
              ...
              description: "Team details registered successfully",
            },
            {
              title: "Player 1",
              description: "Player 1 registered successfully",
            },
            {
              title: "Player 2",
              description: "Player 2 registered successfully",
            },
            {
              title: "Player 3",
              description: "Player 3 registered successfully",
            },
            {
              title: "Player 4",
              description: "Player 4 registered successfully",
            },
            {
              title: "Player 5",
              description: "Player 5 registered successfully",
            },
            {
              title: "Player 6",
              description: "Player 6 registered successfully",
            },
            {
              title: "Player 7",
              description: "Player 7 registered successfully",
            },
            {
              title: "Player 8",
              description: "Player 8 registered successfully",
            },
            {
              title: "Player 9",
              description: "Player 9 registered successfully",
            },
            {
              title: "Player 10",
              description: "Player 10 registered successfully",
            },
            {
              title: "Player 11",
              description: "Player 11 registered successfully",
            },
            {
              title: "Player 12",
              description: "Player 12 registered successfully",
            },
            {
              title: "Player 13",
              description: "Player 13 registered successfully",
            },
            {
              title: "Player 14",
              description: "Player 14 registered successfully",
            },
            {
              title: "Player 15",
              description: "Player 15 registered successfully",
            },
            {
              title: "Player 16",
              description: "Player 16 registered successfully",
            },
            {
              title: "Player 17",
              description: "Player 17 registered successfully",
            },
            {
              title: "Player 18",
              description: "Player 18 registered successfully",
            },
            {
              title: "Complete",
          ...
          <div className="mb-8">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2.5">
              <div
                ...
                style={{
                  width: `${(currentStep.player / currentStep.total) * 100}%`,
                }}
              ></div>
            </div>
          </div>

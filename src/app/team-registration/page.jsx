...
const page = () => {
  ...
  const validateForm = () => {
    ...
    else if (isNaN(formData.batchYear))
      newErrors.batchYear = 'Batch year must be a number';
    else if (formData.batchYear < 2000 || formData.batchYear > 2099)
      newErrors.batchYear = 'Please enter a valid year between 2000 and 2099';
    if (!formData.captainName)
      newErrors.captainName = 'Captain name is required';
    if (!formData.viceCaptainName)
      newErrors.viceCaptainName = 'Vice-captain name is required';

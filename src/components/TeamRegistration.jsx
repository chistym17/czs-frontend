        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2">Tournament Schedule</h3>
              <p className="text-gray-600">
                Matches scheduled from March to June 2024
              </p>
            </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Don't miss your chance to be part of the most prestigious football tournament. 
              Limited spots available for qualified teams.
            </p>
            <Link 
              href="/register" 
